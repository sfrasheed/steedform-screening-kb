...
⛔ **"Curves >40mm" was STRUCK from layer 2 on 23 July 2026** and must never be re-added. Above a material's polish limit the curve becomes a faceted mitre — 🟡 plus a mandatory documented client sign-off, not a decline `[R-D5 v8]`.
