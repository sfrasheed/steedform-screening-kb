...
|---|---|---|---|---|
| **Arris** | 12 · 20\* · 30 · 40\* · 50 · 60 · 70 · 80 · 90 · 100 · 150 · 200 | ✓ EdiPlus (≤80 calibrated; >80 hand) | per §5 | **All materials** (build path per §4). **THE DEFAULT — and the default is ASSUMED where no profile is noted**, per the Terms & Conditions, changed only on the customer's request. An unstated profile is not missing information `[R-ASK v2]`. |
